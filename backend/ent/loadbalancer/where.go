...
func Price(v float64) predicate.LoadBalancer {
	return predicate.LoadBalancer(sql.FieldEQ(FieldPrice, v))
}
...
func PriceEQ(v float64) predicate.LoadBalancer {
	return predicate.LoadBalancer(sql.FieldEQ(FieldPrice, v))
}

// PriceNEQ applies the NEQ predicate on the "Price" field.
func PriceNEQ(v float64) predicate.LoadBalancer {
	return predicate.LoadBalancer(sql.FieldNEQ(FieldPrice, v))
}

// PriceIn applies the In predicate on the "Price" field.
func PriceIn(vs ...float64) predicate.LoadBalancer {
	return predicate.LoadBalancer(sql.FieldIn(FieldPrice, vs...))
}

// PriceNotIn applies the NotIn predicate on the "Price" field.
func PriceNotIn(vs ...float64) predicate.LoadBalancer {
	return predicate.LoadBalancer(sql.FieldNotIn(FieldPrice, vs...))
}

// PriceGT applies the GT predicate on the "Price" field.
func PriceGT(v float64) predicate.LoadBalancer {
	return predicate.LoadBalancer(sql.FieldGT(FieldPrice, v))
}

// PriceGTE applies the GTE predicate on the "Price" field.
func PriceGTE(v float64) predicate.LoadBalancer {
	return predicate.LoadBalancer(sql.FieldGTE(FieldPrice, v))
}

// PriceLT applies the LT predicate on the "Price" field.
func PriceLT(v float64) predicate.LoadBalancer {
	return predicate.LoadBalancer(sql.FieldLT(FieldPrice, v))
}

// PriceLTE applies the LTE predicate on the "Price" field.
func PriceLTE(v float64) predicate.LoadBalancer {
	return predicate.LoadBalancer(sql.FieldLTE(FieldPrice, v))
}

// HasPanierLoadBalancer applies the HasEdge predicate on the "panierLoadBalancer" edge.
func HasPanierLoadBalancer() predicate.LoadBalancer {
...
func HasPanierLoadBalancerWith(preds ...predicate.PanierLoadBalancer) predicate.LoadBalancer {
	return predicate.LoadBalancer(func(s *sql.Selector) {
