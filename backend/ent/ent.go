...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			instances.Table:           instances.ValidColumn,
			loadbalancer.Table:        loadbalancer.ValidColumn,
			objectstorage.Table:       objectstorage.ValidColumn,
			panier.Table:              panier.ValidColumn,
			panierblockstorage.Table:  panierblockstorage.ValidColumn,
			panieripaddress.Table:     panieripaddress.ValidColumn,
			panierinstances.Table:     panierinstances.ValidColumn,
			panierloadbalancer.Table:  panierloadbalancer.ValidColumn,
			panierobjectstorage.Table: panierobjectstorage.ValidColumn,
		})
	})
